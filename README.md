...
* `pageSize` - This defines the page size of the database. This is 8,192 by default (LMDB and previous versions defaulted to 4,096). You may want to consider setting this to 16,384 if you are I/O bound on larger databases or 4,096 where you need more efficient memory usage. Note that this only effects the page size of new databases (does not affect existing databases).
